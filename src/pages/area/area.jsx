...
const Area = () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      {/* <Addarea open={openAdd} onClose={() => {setOpenAdd(false)}} fetchData={fetchData} />*/}
      <EditArea open={openEdit} areaId={editAreaId} onClose={() => { setOpenEdit(false)}}
      />
    </Grid>
  )
}
